      ...
      <div className="container">
        <div className="med-programms">
          <div className="med-programms-top">
            ...
            <p>
              Оздоровительные программы разрабатываются и совершенствуются в
              сотрудничестве с НИИ физиотерапии, медицинской климатологии и
              реабилитации имени Сеченова.
            </p>
          </div>
          <div className="med-programms-cards">
            <Row>
              <Col md={2} className="med-programms-card">
                ...
                <img src={card1} alt="" />
                <p>
                  Системный подход программы за короткий период позволяет
                  получить ощутимый результат сразу после прохождения курса
                </p>
              </Col>
              ...
              <Col md={2} className="med-programms-card">
                ...
                <img src={card3} alt="" />
                <p>
                  Здоровье сердца: комплексный подход к восстановлению и
                  профилактике
                </p>
              </Col>
              ...
              <Col md={2} className="med-programms-card">
                ...
                <img src={card4} alt="" />
                <p>
                  Целостный подход к восстановлению функций опорно-двигательного
                  аппарата
                </p>
              </Col>
              ...
              <Col md={2} className="med-programms-card">
                ...
                <img src={card2} alt="" />
                <p>
                  Комплексный подход к восстановлению и укреплению органов
                  дыхания
                </p>
              </Col>
            </Row>
            ...
            <Col md={4}>
              <div className="advantages-column">
                ...
                <div className="advantages-column-right">
                  ...
                  <p>
                    Оздоровительные программы разрабатываются и совершенствуются
                    в сотрудничестве с НИИ
                  </p>
                </div>
              </div>
            </Col>
            <Col md={4}>
              <div className="advantages-column">
                ...
                <div className="advantages-column-right">
                  ...
                  <p>
                    Оснащен всем необходимым для приятного семейного отдыха{" "}
                  </p>
                </div>
              </div>
            </Col>
            <Col md={4}>
              <div className="advantages-column">
                ...
                <div className="advantages-column-right">
                  ...
                  <p>
                    Целый реликтовый парк и множество троп для неспешных
                    прогулок{" "}
                  </p>
                </div>
              </div>
            ...
            <Col md={4}>
              <div className="advantages-column">
                ...
                <div className="advantages-column-right">
                  ...
                  <p>
                    Концертные программы для родителей и увлекательная детская
                    анимация{" "}
                  </p>
                </div>
              </div>
            ...
            <Col md={4}>
              <div className="advantages-column">
                ...
                <div className="advantages-column-right">
                  ...
                  <p>
                    Наши гости могут наслаждаться природой и
            ...
            <Col md={4}>
              <div className="advantages-column">
                ...
                <div className="advantages-column-right">
                  ...
                  <p>
                    {" "}
                    Разнообразное и здоровое питание, по системе “Шведский стол”{" "}
                  </p>
                </div>
              </div>
            </Col>
