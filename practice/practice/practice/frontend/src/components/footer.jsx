...
const Footer = () =>{
 const notify = () => toast.success('Email отправлен! Спасибо!', {position: "bottom-right", theme:"dark"})
  return(
    <>
    <footer>
    ...
    <div className="socials">
      <a href=""><img src={social1} width={'35px'} height={'40px'} alt="" />
        </a>
        <a href=""><img src={social2} width={'40px'} height={'40px'}alt="" />
          </a>
          <a href=""><img src={social3} alt="" width={'35px'} height={'40px'}/>
            </a>
            <a href="">
